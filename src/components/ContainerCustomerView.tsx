  ...
  return (
    <div className="container-customer-view overflow-xsc pb-4">
      <div ref={listElement} className="customer-box flex flex-aie text-c">
        {customerList.map((customer,k) => <div className="hover-view position-shaft" style={{width:setWidthWindow(),height: `${customer.value}px`,backgroundColor: helperColor.getRGB()}} key={`customer${k}`}>
          {customer.value}
          <div className="view position-item-c max-h70" style={{width:"180px"}} >
